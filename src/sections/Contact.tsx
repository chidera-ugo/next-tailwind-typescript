const Contact = (): JSX.Element => {
	const socials = [
		{
			title: "twitter",
			url: "https://twitter.com/delbott",
		},
		{
			title: "github",
			url: "https://githun.com/delbott",
		},
		{
			title: "linkedIn",
			url: "https://linkedin.com/delbott",
		},
		{
			title: "instagram",
			url: "https://instagram.com/delbott",
		},
	]

	return (
		<div className="lg-lg:grid grid-cols-12 max-w-full mx-auto gap-24 px-12 py-36">
			<div className="col-span-6 flex flex-col align-middle justify-center">
				<div className="my-auto">
					<h3 className="text-gray-800 text-3xl font-bold">Get In Touch</h3>
					<p className="mt-8">
						Fill up the form and we will get back to you within 24 hours. You
						can also reach out to us via email, phone or our social media.
					</p>
					...
					<div className="mt-8">
						<div className="flex align-middle my-4">
							<svg
								...
								className="h-6 w-6 text-primary-main mr-2"
								fill="none"
								viewBox="0 0 24 24"
								stroke="currentColor"
							>
							...
							<h5 className="text-gray-800">help@delbott.com</h5>
						</div>
						...
						<div className="flex align-middle my-4">
							...
							<h5 className="text-gray-800">+234 808 990 2345</h5>
						</div>
						...
						<div className="flex align-middle my-4">
							...
							<h5 className="text-gray-800">Jabi District, Abuja</h5>
						</div>
					</div>
          ...
          "
            ...
            "
							>
								...
								<svg
									v-else-if="social.title === 'twitter'"
									width="24"
									height="24"
									viewBox="0 0 24 24"
									fill="none"
      ...
      "
			>
				<div className="bg-primary-main p-12 rounded-3xl">
					<form
						action="
        ...
        "
                ...
                px-4
                focus:ring-2
                ring-white ring-offset-2 ring-offset-primary-main
                duration-300
                transition
                ease-linear
                focus:outline-none
              ...
              "
                ...
                border-0
                text-gray-700
                border-b-3 border-secondary-default
                focus:border-0 focus:border-secondary-default focus:ring-2
                bg-white
                resize-none
                px-4
                focus:ring-white
                focus:ring-offset-2
                focus:ring-offset-primary-main
                duration-300
                transition
                ease-linear
                focus:outline-none
